...
import (
	...
	"io"
	"os"
	"github.com/zerebubuth/govecamole/vecmap"
)
...
func main() {
	...
	err := vecmap.RegisterDefaultDatasources()
	if err != nil {
		fmt.Printf("Ooops, can't register datasources: %s\n", err.Error())
		return
	}

	m, err := vecmap.New(256, 256)
	if err != nil {
...
point,"POINT (0 0)"
	...
	req, err := vecmap.NewRequestZXY(256, 256, 0, 0, 0)
	if err != nil {
	...
	opts, err := vecmap.DefaultOptions()
	if err != nil {
	...
	err = vecmap.Render(&buf, m, req, opts)
	if err != nil {
